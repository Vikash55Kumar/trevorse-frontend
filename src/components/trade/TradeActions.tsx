  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2">
        <button className="flex-1 py-2 border rounded-lg text-sm font-medium hover:bg-gray-100">
          Market
        </button>
        <button className="flex-1 py-2 border rounded-lg text-sm font-medium bg-gray-100">
          Limit
        </button>
      </div>
